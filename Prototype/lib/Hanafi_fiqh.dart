...
class Hanafia extends StatefulWidget {
  const Hanafia({Key? key}) : super(key: key);

  @override
  State<Hanafia> createState() => _HanafiaState();
}

class _HanafiaState extends State<Hanafia> {
  @override
    ...
    return MaterialApp(
      home: Scaffold(
        ...
        appBar: GFAppBar(
          ...
          title: Text(
            "Hanafi Fiqh Inheritance Calculation",
            style: TextStyle(
                fontSize: 17,
        ...
        body: Container(
          child: Column(
            children: [
              ...
              Text("INHERITANCE RIGHTS ACCORDING TO ISLAMIC SHARIAH",
